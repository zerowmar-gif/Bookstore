...
def main():
    ...
    while True:
        ...
        choice = input("Виберіть пункт: ").strip()
        ...
        if choice == "0":
            ...
            while True:
                    ...
                    print("9) Загальний прибуток за період")
                    print("10) Топ автор за період")
                    print("11) Топ жанр за період")
                    print("12) Експорт усіх продажів у CSV")
                    print("13) Експорт продажів за період у CSV")
                    print("0) Назад")

                    r = input("Виберіть: ").strip()
